...
//       Member member = SessionUtil.getCurrentUser();
//        if (member != null) {
...
//
     ...
     * @return 认证信息
     * @throws RRException 认证异常
     */
    @Override
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws RRException {
        ...
        if (authenticationToken instanceof UsernamePasswordToken) {
            ...
            member = shiroService.login(null, token.getUsername(), String.valueOf(token.getPassword()));
            if (member != null) {
        ...
        if (member != null) {
            SessionUtil.setAttribute(SessionEnum.CURRENT_USER, member);
        }
